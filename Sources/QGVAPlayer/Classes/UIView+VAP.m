...
@interface UIView () <QGAnimatedImageDecoderDelegate, QGHWDMetelViewDelegate, QGVAPMetalViewDelegate, QGVAPConfigDelegate>
...
- (BOOL)hwd_renderByOpenGL {
    return NO;
}

- (void)setHwd_renderByOpenGL:(BOOL)hwd_renderByOpenGL {
    if (hwd_renderByOpenGL) {
        VAP_Warn(kQGVAPModuleCommon, @"OpenGLES rendering has been removed. QGVAPlayer always uses Metal.");
    }
}
